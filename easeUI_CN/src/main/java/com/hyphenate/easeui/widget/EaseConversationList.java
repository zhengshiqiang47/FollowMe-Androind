...
public class EaseConversationList extends ListView {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        primaryColor = context.getResources().getColor(R.color.black_deep);
        secondaryColor = context.getResources().getColor( R.color.list_itease_secondary_color);
        timeColor = context.getResources().getColor( R.color.list_itease_secondary_color);
