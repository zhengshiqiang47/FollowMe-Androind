...
//    protected EaseTitleBar titleBar;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        titleName = (TextView) v.findViewById(R.id.chat_title_name);
        backIcon = (ImageView) v.findViewById(R.id.chat_back);
        deleteIcon = (ImageView) v.findViewById(R.id.chat_more);
        return v;
    }
    ...
    protected void initView() {
        ...
        refreshView.setPullDownStr("加载更多");
        refreshView.setRefreshingStr("正在加载...");
        swipeRefreshLayout.setHeaderView(refreshView);
        LoadingView loadingView = new LoadingView(getActivity());

        swipeRefreshLayout.setBottomView(loadingView);
...
//                R.color.holo_orange_light, R.color.holo_red_light);
    ...
    protected void setUpView() {
        titleName.setText(toChatUsername);
        if (chatType == EaseConstant.CHATTYPE_SINGLE) {
            // set title
            if(EaseUserUtils.getUserInfo(toChatUsername) != null){
                EaseUser user = EaseUserUtils.getUserInfo(toChatUsername);
                if (user != null) {
                    titleName.setText(user.getNick());
                }
            }
//            titleBar.setRightImageResource(R.drawable.ease_mm_title_remove);
        } else {
        	deleteIcon.setImageResource(R.drawable.ease_to_group_details_normal);
            if (chatType == EaseConstant.CHATTYPE_GROUP) {
                //group chat
                EMGroup group = EMClient.getInstance().groupManager().getGroup(toChatUsername);
                if (group != null)
                    titleName.setText(group.getGroupName());
            ...
            public void onSuccess(final EMChatRoom value) {
                getActivity().runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if (room != null) {
                            titleName.setText(room.getName());
